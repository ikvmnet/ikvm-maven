...
namespace IKVM.Maven.Sdk.Tests
{
    ...
    public partial class ProjectTests
    {
        ...
        [DataRow(EnvironmentPreference.Core, "net481", "win-x64", "{0}.exe", "{0}.dll")]
        ...
        [DataRow(EnvironmentPreference.Framework, "net481", "win-x86", "{0}.exe", "{0}.dll")]
        [DataRow(EnvironmentPreference.Framework, "net481", "win-x64", "{0}.exe", "{0}.dll")]
        ...
        public void CanBuildProject(EnvironmentPreference env, string tfm, string rid, string exe, string lib)
        {
            ...
            if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows) == false)
                if (env == EnvironmentPreference.Framework || tfm == "net472" || tfm == "net481")
                    return;
